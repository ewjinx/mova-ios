...
class Top10ViewController: UIViewController {
    ...
    //var router: Top10RoutingLogic?
    
    private var viewModel: Top10.ViewModel?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "Top 10 Movies This Week"
        
    }
    
    
    
    func configure(with movies: [Home.FetchMovies.ViewModel.DisplayedMovie]) {
        viewModel = Top10.ViewModel(movies: movies)
    }
...
extension Top10ViewController: UICollectionViewDelegate, UICollectionViewDataSource
{
...
extension Top10ViewController: HomeDisplayLogic {
    
    
    @MainActor
    func displayMovies(viewModel: Home.FetchMovies.ViewModel) {
        self.viewModel = Top10.ViewModel(movies: viewModel.top10)
        collectionView.reloadData()
    }
